  ...
  class Document
    ...
    def render
      buffer = ::Zip::OutputStream.write_buffer do |zip|
        ...
        render_footer_relationships(zip) # Must go here: Depends on header renderer
    ...
    def render_footer_relationships(zip)
      content = ::Caracal::Renderers::RelationshipsRenderer.new(self, footer_relationships).to_xml
    ...
    def render_media(zip)
      images = (relationships + header_relationships + footer_relationships).select { |r| r.relationship_type == :image }
      images.each do |rel|
